            ...
            {loading ? (
                ...
                <div className="space-y-6">
                            ...
                            >
                                <div className="flex justify-between items-start mb-4">
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <h3 className="font-bold text-zinc-900 dark:text-zinc-100 truncate max-w-[200px]">
                                            {report.url.replace(/^https?:\/\//, '')}
                                        </h3>
                                    </div>
                                    {report.performance_score !== null && (
                                        <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm ${getScoreColor(report.performance_score)}`}>
                                ...
                                <div className="flex items-center gap-2 mb-5">
                                    <div className="flex items-center gap-1.5 px-2 py-1 bg-zinc-100 dark:bg-zinc-800 rounded text-[10px] font-semibold uppercase text-zinc-500">
                                ...
                                <div className="grid grid-cols-2 gap-3 pt-4 border-t border-zinc-100 dark:border-zinc-800">
                                    <Link
                                        ...
                                        className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-blue-600 text-white text-xs font-bold transition-transform active:scale-95"
                                    >
                                        View Report
                                    </Link>
                                    <Link
                                        href={`/results/${report.id}?share=true`}
                                        className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-300 text-xs font-bold transition-transform active:scale-95"
                                    >
                                        Share
                                    </Link>
                                </div>
                    ...
                    <motion.div
                        initial={{ opacity: 0, y: 10 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="hidden md:block bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl overflow-hidden shadow-sm"
                    >
