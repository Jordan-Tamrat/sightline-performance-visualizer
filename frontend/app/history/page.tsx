...
import { Monitor, Smartphone, Wifi, Signal, ArrowRight, Loader2, Clock } from 'lucide-react';
                                    ...
                                    <tr key={report.id} className="group hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                                        ...
                                        <td className="px-6 py-5 text-right">
                                            <Link
                                                ...
                                                className="inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-zinc-800 hover:bg-blue-50 dark:hover:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-full text-sm font-medium transition-colors border border-zinc-200 dark:border-zinc-700 shadow-sm group-hover:border-blue-200 dark:group-hover:border-blue-800/50"
                                            >
                                                View Report
                                            </Link>
                                        </td>
